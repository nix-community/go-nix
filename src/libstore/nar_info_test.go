...
Sig: hydra.da-int.net-1:JXQ3Z/PXf0EZSFkFioa4FbyYpbbTbHlFBtZf4VqU0tuMTWzhMD7p9Q7acJjLn3jofOtilAAwRILKIfVuyrbjAA==
`
...
func TestNarInfoParser(t *testing.T) {
	...
	assert.Equal(t, &libstore.NarInfo{
		...
		Signatures: []string{
			...
			"hydra.da-int.net-1:JXQ3Z/PXf0EZSFkFioa4FbyYpbbTbHlFBtZf4VqU0tuMTWzhMD7p9Q7acJjLn3jofOtilAAwRILKIfVuyrbjAA==",
		},
	}, n)
